...
var enrich = function(obj, currentEl) {
  ...
  if(Q.isPromiseAlike(obj) && !obj.__wd_promise_enriched) {    
    var promise = obj;
    ...
    _(promise).functions().each(function(fname) {
      ...
      promise[fname] = function() {
        return enrich.call(_this, _orig.apply(this, __slice.call(arguments, 0)), currentEl);
      };
    });

    // we get the list of methods dynamically.
    var browserMethods = _.union(_.keys(commands));
      ...
      promise[fname] = function() {
        ...
        return this.then(function(res) {
          ...
          if(isBrowserMethod && isElementMethod) {
            ...
            } else if(fname.match(/element/) || (BaseElement && args[0] instanceof BaseElement)) {
