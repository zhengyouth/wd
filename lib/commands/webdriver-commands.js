...
var safeExecuteJsScript =
  helpers.inlineJs(fs.readFileSync( __dirname + "/../../browser-scripts/safe-execute.js", 'utf8'));
...
var safeExecuteAsyncJsScript =
  helpers.inlineJs(fs.readFileSync( __dirname + "/../../browser-scripts/safe-execute-async.js", 'utf8'));
...
commands.waitFor = function(){
  ...
  if(opts.asserter instanceof AsyncAsserter) {
    _assert = function() {
      return Q.nfcall(opts.asserter.assert, _this._asyncFacade).then(function(res) {
...
commands.waitForVisible = function(using, value, timeout, pollFreq) {
  ...
  return commands.waitForElement
    .apply(this, [using, value, predefinedAsserters.isVisible, timeout, pollFreq])
    .catch(function(err) {
...
var addMethodsForSuffix = function(type, singular, plural) {
  if(singular){
     ...
     * @docOrder 6
     */
    commands['element' + helpers.elFuncSuffix(type)+ 'IfExists'] = function() {
      var fargs = helpers.varargs(arguments);
      var args = fargs.all;
      args.unshift(helpers.elFuncFullType(type));
...
var _waitForConditionInBrowserJsScript =
  helpers.inlineJs(fs.readFileSync( __dirname + "/../../browser-scripts/wait-for-cond-in-browser.js", 'utf8'));
