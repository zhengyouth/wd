...
Webdriver.prototype._qInit = function() {
...
Webdriver.prototype._init = function() {
  ...
  return this._qInit.apply(this, fargs.all).nodeify(fargs.callback);
};

// standard jsonwire call
Webdriver.prototype._qJsonWireCall = function(opts) {  
  var _this = this;
...
Webdriver.prototype._jsonWireCall = function() {  
  var fargs = utils.varargs(arguments);
  var opts = fargs.first;
  var cb = opts.cb;
  return this._qJsonWireCall(opts).nodeify(cb);
};

Webdriver.prototype._qSauceJobUpdate = function(jsonData) {
  var _this = this;
...
Webdriver.prototype._sauceJobUpdate = function() {
  var fargs = utils.varargs(arguments);
  return this._qSauceJobUpdate.apply(this, fargs.all).nodeify(fargs.callback);
};
