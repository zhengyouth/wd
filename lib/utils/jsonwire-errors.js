var JSONWIRE_ERRORS = [
  ...
  },
  {
    ...
    detail: 'An element could not be located on the page using the given ' +
      'search parameters.'
  },
  {
    status: 8,
    summary: 'NoSuchFrame',
    detail: 'A request to switch to a frame could not be satisfied because ' +
  ...
  },
  {
    ...
    detail: 'An element command failed because the referenced element is no ' +
      'longer attached to the DOM.'
  },
  {
    status: 11,
    summary: 'ElementNotVisible',
    detail: 'An element command could not be completed because the element ' +
  ...
  },
  {
    ...
    detail: 'An unknown server-side error occurred while processing the ' +
      'command.'
  },
  {
    status: 15,
  ...
  },
  {
    ...
    detail: 'A request to switch to a different window could not be ' +
      'satisfied because the window could not be found.'
  },
  {
    status: 24,
    summary: 'InvalidCookieDomain',
    detail: 'An illegal attempt was made to set a cookie under a different ' +
  ...
  },
  {
    ...
    detail: 'An attempt was made to operate on a modal dialog when one was ' +
      'not open.'
  },
  {
    status: 28,
