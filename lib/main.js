var __slice = Array.prototype.slice,
    ...
    PromiseWebdriver = require('./webdriver-promise'),
...
function remote() {
  ...
  switch (driverType) {
    case 'async':
      return (new PromiseWebdriver(rwc, false))._asyncFacade; 
      //return new AsyncWebdriver(rwc);
    case 'promise': 
      return new PromiseWebdriver(rwc, false);
    case 'promiseChain': 
...
function addPromiseMethod(name, method) {
  ...
  PromiseWebdriver.addCommand(name, method);
}

function addAsyncMethod(name, method) {
  var wrappedMethod = PromiseWebdriver.wrapAsyncCommand(name, method);
...
module.exports = {
  ...
  PromiseChainWebdriver: PromiseWebdriver,
  ...
  AsyncAsserter: require('./asserters').AsyncAsserter,
