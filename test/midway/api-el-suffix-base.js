...
exports.test = function (
  suffix, extraDesc, suffixPartials, criterias) {
  ...
  describe('api-el-' + extraDesc + ' ' + env.ENV_DESC, function () {
    ...
    it('browser.' + elementFuncName, function () {
      return Q.all([
        ...
        browser[elementFuncName](criterias.invalid)
    ...
    it('browser.' + elementFuncNameOrNull, function () {
      return browser[
        elementFuncNameOrNull](criterias.valid)
        .should.eventually.exist[
        elementFuncNameOrNull](criterias.invalid)
    ...
    it('browser.' + elementFuncNameIfExists, function () {
      return browser[
        ...
        elementFuncNameIfExists](criterias.invalid)
          .should.eventually.be.a('undefined');
    });
    ...
    partials['browser.' + waitForElementFuncName]  =
      '<div id=\'theDiv\'></div>';
    ...
    partials['browser.' + waitForVisibleFuncName]  =
      '<div id=\'theDiv\'></div>';
