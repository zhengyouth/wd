...
describe('api-various ' + env.ENV_DESC, function () {
  ...
  it('browser.uploadFile', function () {
    return browser
      ...
      .uploadFile('test/midway/assets/tux.jpg')
        .should.eventually.include('tux.jpg');
  });
  ...
  it('browser.isDisplayed', function () {
    return browser
      ...
      .elementByCss('#theDiv .hidden').isDisplayed()
  ...
  it('browser.isEnabled', function () {
    return browser
      ...
      .elementByCss('#theDiv .disabled')
        .isEnabled().should.eventually.not.be.ok;
  });
