...
describe('asserters ' + env.ENV_DESC, function () {
  ...
  var appendChild =
    'setTimeout(function () {\n' +
    ' $(\'#theDiv\').append(' +
      '\'<div class=\\\'child\\\'>a waitFor child</div>\');\n' +
    '}, arguments[0]);\n';
  ...
  it('asserters.nonEmptyText', function () {
    return browser
      ...
      .waitForElementByCss('#theDiv .child', asserters.nonEmptyText,
        2 * env.BASE_TIME_UNIT)
  ...
  it('asserters.textInclude', function () {
    return browser
      ...
      .waitForElementByCss('#theDiv .child',
        asserters.textInclude('a waitFor child'), 2 * env.BASE_TIME_UNIT)
      .text().should.become('a waitFor child');
  });
  ...
  it('asserters.isDisplayed', function () {
    return browser
      ...
      .waitForElementByCss('#theDiv .child', asserters.isDisplayed,
        2 * env.BASE_TIME_UNIT)
      .waitForElementByCss('#theDiv .child', asserters.isVisible,
        2 * env.BASE_TIME_UNIT) // deprecated
      .text().should.become('a waitFor child');
  });
  ...
  it('asserters.isNotDisplayed', function () {
    return browser
      ...
      .waitForElementByCss('#theDiv .child', asserters.isNotDisplayed,
        2 * env.BASE_TIME_UNIT)
      .waitForElementByCss('#theDiv .child', asserters.isHidden,
        2 * env.BASE_TIME_UNIT) // deprecated
      .text().should.become('');
  });
  ...
  it('asserters.jsCondition', function () {
    ...
    return browser
      .executeAsync(
        ...
        ' setTimeout(function () {\n' +
        ' $(\'#theDiv\').html(' +
          '\'<div class=\\\'child\\\'>a waitForCondition child</div>\');\n' +
        ' }, arguments[0]);\n' +
        'done();\n',
        [env.BASE_TIME_UNIT]
      )
      ...
      .waitFor(asserters.jsCondition(exprCond, true),
