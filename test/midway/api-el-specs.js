...
describe('api-el ' + env.ENV_DESC, function () {
  ...
  it('browser.waitForElement @skip-ios @skip-android', function () {
    ...
    return browser
      .executeAsync(prepareJs(
        ...
        'setTimeout(function () {\n' +
        ' $(\'#theDiv\').append(' +
          '\'<div class=\\\'child\\\'>a waitForElement child</div>\');\n' +
        '}, arguments[0]);\n' +
        'done();\n'),
        [env.BASE_TIME_UNIT]
      )
      ...
      .then(function () {
        return browser
          .waitForElement('css selector', '#wrongsel .child',
            0.1 * env.BASE_TIME_UNIT)
  ...
  it('browser.waitForVisible @skip-ios @skip-android', function () {
    return browser
      .executeAsync(prepareJs(
        ...
        'var done = args[args.length -1];\n' +
        '$(\'#theDiv\').append(' +
          '\'<div class=\\\'child\\\'>a waitForVisible child</div>\');\n' +
        '$(\'#theDiv .child\').hide();\n' +
        'setTimeout(function () {\n' +
        ' $(\'#theDiv .child\').show();\n' +
        '}, arguments[0]);\n' +
      ...
      .then(function () {
        return browser
          .waitForVisible('css selector', '#wrongsel .child',
            0.1 * env.BASE_TIME_UNIT)
  ...
  it('browser.getValue', function () {
    return browser
      ...
      .elementByCss('#theDiv input').getValue()
        .should.become('Hello getValueTest!')
      .elementByCss('#theDiv textarea').then(function (el) {
        return browser.getValue(el).should.become('Hello getValueTest2!');
      })
      .elementByCss('#theDiv textarea').getValue()
        .should.become('Hello getValueTest2!');
  });
  ...
  it('browser.textPresent', function () {
    return browser
      ...
      .elementByCss('#theDiv').textPresent('raining')
